...
function toggleKnifing()
	...
	outputChatBox("Bıçaklanma Koruması "..(state and "Aktif" or "Kapalı"),0,102,255)
...
wndMain = {
	...
	controls = {
		...
		{'chk', id='disableknife', text='Bıçaklanmama', onclick=toggleKnifing, width = 120, height = 19},
		{'chk', id='antiram', text='Araç Hayalet', onclick=toggleGhostmode, width = 125,x = 165},
